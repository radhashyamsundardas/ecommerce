...
function Product() {
  const [showProduct, setShowProduct] = useState(false); //stripe state - NDF
  return (
    <div>
      <div className="card-container">
        ...
        <Card style={style.body}>
          <Card.Img
            variant="top"
            src="https://cdn.shopify.com/s/files/1/0592/3766/2905/products/SKU-Cyber-Monday-4_1400x.png?v=1669607742"
            height={200}
          />
        ...
        <Card style={style.body}>
          <Card.Img
            variant="top"
            src="https://encrypted-tbn2.gstatic.com/shopping?q=tbn:ANd9GcTz7r5BdEyPYcIMgtYyM2TnfEd-OoG3lxss4OZusRBPQCGy0XJ8qiswaSsjgtch_uxIigp9bq8nM4XPXMMT6cXMXionni40blH0&usqp=CAc"
            height={200}
          />
          <Card.Body>
            <Card.Title>Peloton Bike</Card.Title>
            <Card.Text>Finance starting from 0% APR¹ with $0 down.</Card.Text>
            <h6>Price: $1445.00</h6>
            <Button variant="primary">ADD TO CART</Button>
          </Card.Body>
        </Card>
        ...
        <Card style={style.body}>
          <Card.Img
            variant="top"
            src="https://www.relifesports.com/wp-content/uploads/2021/09/best-home-exercise-bike-3.jpg"
            height={200}
          />
        ...
        <Card style={style.body}>
          <Card.Img
            variant="top"
            src="https://m.media-amazon.com/images/I/71fzMIEqzSL._AC_SX679_.jpg"
            height={200}
          />
        ...
        <Card style={style.body}>
          <Card.Img
            variant="top"
            src="https://encrypted-tbn2.gstatic.com/shopping?q=tbn:ANd9GcRkTJa5gls2AYKZmS-A3PHAA798uguZ6kotMkAgUM4tmaNqf2wPtQ7fVLSxSh0S5vrQLVxmygRdxyKbef_6ORDWoKLxCawpbgsRmeELBRc0xaD-HRwXdHTttxeYuGWU&usqp=CAE"
            height={200}
          />

          <Card.Body>
            <Card.Title>
              Exercise Stationary Bike 330Lbs Weight Capacity
            </Card.Title>
            {/* <Card.Text>
  </Card.Text> */}
            <h6>Price: $219.00</h6>
