       ...
       <Card style={{ width: '18rem', height: '25rem' }}>
        <Card.Img variant="top" src="https://staticprod.site.flexispot.com/cdn-cgi/image/dpr=1,format=webp,fit=pad/https://staticprod.site.flexispot.com/flexispot/catalog/product/v/9/v91207.jpg" height={200} />
          <Card.Body>
            ...
            {showProduct ? <StripeContainer/> //id product is present we show strip container - ternary operator
                         : <><h3>Was: $499.00 <br /> Price:	$369.98 <br /> You Save:	$130.00 (22%) </h3>
                        <Button onClick={() => setShowProduct(true)} variant="primary">ADD TO CART</Button>
                        </>}
          </Card.Body>
        </Card>
